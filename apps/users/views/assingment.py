    ...
    def get_context_data(self, **kwargs):
        ...
        context.update({
            ...
            'available_user_types': [
                ...
                {'value': 'parent', 'label': 'Representante'}
            ]
        })
        return context
...
class UserManagementAPIView(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            if user.user_type in ['teacher', 'parent']:
                self.send_registration_email(user.email, user.first_name, password)
    ...
    @staticmethod
    def send_registration_email(email, first_name, password):
        subject = "Registro en el Sistema Académico"
        message = (
            f"Hola {first_name},\n\n"
            "Te damos la bienvenida al Sistema Académico.\n\n"
            f"Tu contraseña temporal es: {password}\n\n"
            "Por favor, accede al sistema y cambia tu contraseña lo antes posible.\n\n"
